...
// Trimmed cascade — only models verified to resolve reliably on this API key.
// Longer cascades produced 404s and timeouts that compounded into Vercel
// 60s function timeouts. To rediscover available models, run:
